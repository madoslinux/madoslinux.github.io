const translations = {
    en: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Automatic GPU detection at boot — Hyprland with 3D acceleration, Sway with software rendering. Both using Nord theme at 800MB RAM.",
    ...
    es: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Detección automática de GPU al inicio — Hyprland con aceleración 3D, Sway con renderizado por software. Ambos con tema Nord a 800MB de RAM.",
    ...
    fr: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Détection automatique GPU au démarrage — Hyprland avec accélération 3D, Sway avec rendu logiciel. Les deux avec thème Nord à 800MB de RAM.",
    ...
    pt: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Detecção automática de GPU na inicialização — Hyprland com aceleração 3D, Sway com renderização por software. Ambos com tema Nord a 800MB de RAM.",
    ...
    it: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Rilevamento automatico GPU all'avvio — Hyprland con accelerazione 3D, Sway con rendering software. Entrambi con tema Nord a 800MB di RAM.",
    ...
    de: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "Automatische GPU-Erkennung beim Start — Hyprland mit 3D-Beschleunigung, Sway mit Software-Rendering. Beide mit Nord-Theme bei 800MB RAM.",
    ...
    zh: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "启动时自动检测 GPU — Hyprland 支持 3D 加速，Sway 支持软件渲染。两者都使用 Nord 主题，内存占用 800MB。",
            lowRam: "低内存优化",
    ...
    ja: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "ブート時の自動GPU検出 — Hyprlandは3Dアクセラレーション、Swayはソフトウェアレンダリング。どちらもNordテーマで800MB RAM。",
            lowRam: "低RAM最適化",
    ...
    ko: {
        ...
        features: {
            ...
            adaptiveDesktopDesc: "부팅 시 자동 GPU 감지 — Hyprland는 3D 가속, Sway는 소프트웨어 렌더링. 모두 Nord 테마, 800MB RAM.",
            lowRam: "저RAM 최적화",
